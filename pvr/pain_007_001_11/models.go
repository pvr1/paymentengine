...
// Models for urn:iso:std:iso:20022:tech:xsd:pain.007.001.11
...
type Document struct {
	...
	CstmrPmtRvsl CustomerPaymentReversalV11 `xml:",any"`
}
...
type CustomerPaymentReversalV11 struct {
	...
	OrgnlPmtInfAndRvsl []OriginalPaymentInstruction41 `xml:"OrgnlPmtInfAndRvsl"`
...
type GroupHeader88 struct {
	...
	GrpRvsl *TrueFalseIndicator `xml:"GrpRvsl"`
...
type OriginalPaymentInstruction41 struct {
	...
	RvslPmtInfId *Max35Text `xml:"RvslPmtInfId"`
	...
	PmtInfRvsl *TrueFalseIndicator `xml:"PmtInfRvsl"`

	RvslRsnInf []PaymentReversalReason9 `xml:"RvslRsnInf"`

	TxInf []PaymentTransaction134 `xml:"TxInf"`
...
type ReversalReason4Choice struct {
	...
	Cd *ExternalReversalReason1Code `xml:"Cd"`
