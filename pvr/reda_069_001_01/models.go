...
// Models for urn:iso:std:iso:20022:tech:xsd:reda.069.001.01
...
type Document struct {
	...
	ReqToPayCdtrEnrlmntStsRpt RequestToPayCreditorEnrolmentStatusReportV01 `xml:",any"`
}
...
type EnrolmentStatus2 struct {
	...
	StsRsn *CreditorEnrolmentStatusReason2 `xml:"StsRsn"`

	OrgnlEnrlmntRef *OriginalEnrolment2Choice `xml:"OrgnlEnrlmntRef"`

	FctvEnrlmntDt *DateAndDateTime2Choice `xml:"FctvEnrlmntDt"`
...
const ServiceRequestStatus1CodeAcpt ServiceRequestStatus1Code = "ACPT"

const ServiceRequestStatus1CodeRjct ServiceRequestStatus1Code = "RJCT"
