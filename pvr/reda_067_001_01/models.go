...
// Models for urn:iso:std:iso:20022:tech:xsd:reda.067.001.01
...
type Document struct {
	...
	ReqToPayCdtrEnrlmntAmdmntReq RequestToPayCreditorEnrolmentAmendmentRequestV01 `xml:",any"`
}
...
type CreditorEnrolmentAmendment3 struct {
	...
	AmdmntRsn *CreditorEnrolmentAmendmentReason2 `xml:"AmdmntRsn"`
...
type CreditorEnrolmentAmendment4 struct {
	...
	CdtrEnrlmnt *CreditorEnrolment4 `xml:"CdtrEnrlmnt"`

	ActvtnData *CreditorInvoice4 `xml:"ActvtnData"`
...
type CreditorInvoice4 struct {
	...
	LtdPresntmntInd *TrueFalseIndicator `xml:"LtdPresntmntInd"`

	CstmrIdTp *CustomerTypeRequest2 `xml:"CstmrIdTp"`

	CtrctFrmtTp []DocumentFormat2Choice `xml:"CtrctFrmtTp"`

	CtrctRefTp []DocumentType1Choice `xml:"CtrctRefTp"`

	CdtrInstr *Max500Text `xml:"CdtrInstr"`
...
type CustomerTypeRequest2 struct {
	...
	Reqd RequestedIndicator `xml:"Reqd"`

	OrgTp *OrganisationType2 `xml:"OrgTp"`

	PrvtTp *PersonType2 `xml:"PrvtTp"`
...
type OrganisationType2 struct {
	...
	AnyBIC *RequestedIndicator `xml:"AnyBIC"`

	LEI *RequestedIndicator `xml:"LEI"`

	EmailAdr *RequestedIndicator `xml:"EmailAdr"`

	Othr []GenericOrganisationType1 `xml:"Othr"`
...
type PersonType2 struct {
	...
	DtAndPlcOfBirth *RequestedIndicator `xml:"DtAndPlcOfBirth"`

	EmailAdr *RequestedIndicator `xml:"EmailAdr"`

	Othr []GenericPersonType1 `xml:"Othr"`
