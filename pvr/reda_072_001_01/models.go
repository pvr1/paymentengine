...
// Models for urn:iso:std:iso:20022:tech:xsd:reda.072.001.01
...
type Document struct {
	...
	ReqToPayDbtrActvtnCxlReq RequestToPayDebtorActivationCancellationRequestV01 `xml:",any"`
}
...
type DebtorActivationCancellation2 struct {
	...
	CxlRsn *DebtorActivationCancellationReason2 `xml:"CxlRsn"`
