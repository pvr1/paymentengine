...
// Models for urn:iso:std:iso:20022:tech:xsd:reda.073.001.01
...
type Document struct {
	...
	ReqToPayDbtrActvtnStsRpt RequestToPayDebtorActivationStatusReportV01 `xml:",any"`
}
...
type ActivationStatus2 struct {
	...
	StsRsn *DebtorActivationStatusReason2 `xml:"StsRsn"`

	OrgnlActvtnRef *OriginalActivation2Choice `xml:"OrgnlActvtnRef"`

	FctvActvtnDt *DateAndDateTime2Choice `xml:"FctvActvtnDt"`
